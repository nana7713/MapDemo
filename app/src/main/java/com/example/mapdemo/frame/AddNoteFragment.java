...
public class AddNoteFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mIat = SpeechRecognizer.createRecognizer(requireActivity(), mInitListener);
        // 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
        mIatDialog = new RecognizerDialog(requireActivity(), mInitListener);
        mSharedPreferences = requireActivity().getSharedPreferences("ASR",
    ...
    private void printResult(RecognizerResult results) {
        ...
        contentEditText.setText(resultBuffer.toString()); // 听写结果显示
    }
    ...
    // 假设 JsonParser 类存在，需要确保该类存在于项目中
